		...
		<div className="auth-page font-display">
			<div className="auth-container">
				...
				<div className="auth-brand">
						...
						>
							<div
								style={{
									...
									borderRadius: "12px",
									background:
										"linear-gradient(135deg, #4e9239 0%, #3a6e2c 100%)",
									display: "flex",
									alignItems: "center",
					...
					<p
						style={{ fontSize: "0.9375rem", color: "#5e7c52", lineHeight: 1.7 }}
					>
						AI-powered marketplace connecting farmers, buyers, and transporters
						across Africa.
					</p>
