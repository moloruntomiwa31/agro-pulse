...
import { Check, Truck, Package, MapPin, Phone, ShieldCheck, ClipboardList } from "lucide-react";
  ...
  return (
    <div className="flex-1 overflow-y-auto bg-stone-50/30 p-6">
      <div className="max-w-4xl mx-auto flex flex-col gap-8">
        ...
        {/* Header */}
        <div>
          <h1 className="font-display text-2xl font-bold text-stone-900 mb-1">Live Order Tracking</h1>
          <p className="text-sm text-stone-500">Track your escrow-secured purchases and delivery status in real-time.</p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-stone-200 shadow-sm overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between p-6 border-b border-stone-100 bg-stone-50/50">
            <div>
              <div className="flex items-center gap-3 mb-1">
                <span className="text-sm font-bold text-stone-900">Order #{activeOrder.id}</span>
                <span className="px-2 py-0.5 rounded-full bg-blue-50 text-blue-700 text-[10px] font-bold uppercase tracking-widest border border-blue-100">{activeOrder.status}</span>
              </div>
              <p className="text-xs font-medium text-stone-500">Placed on {activeOrder.date} • ₦{activeOrder.total.toLocaleString()} Total Escrow</p>
            </div>
            
            <div className="mt-4 sm:mt-0 flex items-center gap-2">
              <ShieldCheck size={16} className="text-forest-600" />
              <span className="text-xs font-semibold text-forest-700">Funds Secured in Escrow</span>
            </div>
          </div>
          ...
          <div className="p-6">
              ...
              <div className="flex flex-col md:flex-row justify-between relative z-10 gap-8 md:gap-0">
                ...
                <div className="flex md:flex-col items-center gap-4 md:gap-2 relative w-full">
                  ...
                  <div className="text-left md:text-center mt-0 md:mt-2">
                    <p className="text-sm font-bold text-stone-900">Payment Secured</p>
                    <p className="text-[10px] font-medium text-stone-500 uppercase tracking-widest mt-0.5">Completed</p>
                  </div>
                </div>
                ...
                <div className="flex md:flex-col items-center gap-4 md:gap-2 relative w-full">
                  ...
                  <div className="text-left md:text-center mt-0 md:mt-2">
                    <p className="text-sm font-bold text-stone-900">Harvested & Packed</p>
                    <p className="text-[10px] font-medium text-stone-500 uppercase tracking-widest mt-0.5">Completed</p>
                  </div>
                </div>
                ...
                <div className="flex md:flex-col items-center gap-4 md:gap-2 relative w-full">
                  ...
                  <div className="text-left md:text-center mt-0 md:mt-2">
                    <p className="text-sm font-bold text-blue-700">In Transit</p>
                    <p className="text-[10px] font-medium text-blue-500/80 uppercase tracking-widest mt-0.5">En Route to Buyer</p>
                  </div>
                </div>
                ...
                <div className="flex md:flex-col items-center gap-4 md:gap-2 relative w-full">
                  ...
                  <div className="text-left md:text-center mt-0 md:mt-2">
                    <p className="text-sm font-bold text-stone-400">Delivered</p>
                    <p className="text-[10px] font-medium text-stone-400 uppercase tracking-widest mt-0.5">Pending</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 border-t border-stone-100 pt-6">
              ...
              <div className="flex flex-col gap-6">
                <div>
                  <h3 className="text-[10px] font-bold uppercase tracking-widest text-stone-400 mb-3">Assigned Rider</h3>
                  <div className="flex items-center gap-4 p-3 rounded-xl border border-stone-200 bg-stone-50">
                    <div className="w-10 h-10 rounded-full bg-stone-200 overflow-hidden shrink-0">
                      <img src="https://images.unsplash.com/photo-1506277886164-e25aa3f4ef7f?w=100&q=70" alt="Rider" className="w-full h-full object-cover" />
                    </div>
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-bold text-stone-900 truncate">Ibrahim S.</p>
                      <p className="text-xs font-medium text-stone-500">Toyota Hilux • KAN-891-AB</p>
                    </div>
                ...
                <div>
                  <h3 className="text-[10px] font-bold uppercase tracking-widest text-stone-400 mb-3">Delivery Route</h3>
                  <div className="flex flex-col gap-4 relative">
                    ...
                    <div className="flex items-start gap-3 relative z-10">
                      ...
                      <div>
                        <p className="text-xs font-bold text-stone-900">{activeOrder.items[0]?.farm || "Green Valley Farms"}</p>
                        <p className="text-[10px] text-stone-500 mt-0.5">Pickup Location</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3 relative z-10">
                      ...
                      <div>
                        <p className="text-xs font-bold text-blue-700">Currently in Transit</p>
                        <p className="text-[10px] text-blue-500 mt-0.5">Updated recently</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3 relative z-10">
                      <div className="w-4 h-4 rounded-full bg-stone-200 border-2 border-white mt-0.5 shrink-0" />
                      <div>
                        <p className="text-xs font-bold text-stone-900">Your Location</p>
                        <p className="text-[10px] text-stone-500 mt-0.5">Dropoff Location</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-stone-100 rounded-xl border border-stone-200 overflow-hidden relative min-h-[250px]">
                ...
                <svg className="absolute inset-0 w-full h-full stroke-blue-500 stroke-2 fill-none" preserveAspectRatio="none" viewBox="0 0 100 100">
                  <path d="M 20 20 Q 50 20 50 50 T 80 80" strokeDasharray="4 4" className="opacity-50" />
                ...
                <div className="absolute top-[15%] left-[15%] flex flex-col items-center">
                  ...
                  <span className="text-[9px] font-bold text-stone-500 mt-1 bg-white/80 px-1 rounded">Origin</span>
                </div>
                ...
                <div className="absolute bottom-[15%] right-[15%] flex flex-col items-center">
                  ...
                  <span className="text-[9px] font-bold text-stone-700 mt-1 bg-white/80 px-1 rounded">Destination</span>
                </div>
              </div>
          ...
          <div className="bg-stone-50 border-t border-stone-200 p-6">
            <h3 className="text-[10px] font-bold uppercase tracking-widest text-stone-400 mb-4">Shipment Manifest</h3>
                ...
                <div key={item.id} className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-stone-500 font-medium">{item.quantity} {item.unit}</p>
                    </div>
                  </div>
